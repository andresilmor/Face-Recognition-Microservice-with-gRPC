...
async def extract_faces(img, target_size=(224, 224), face_detector = None, detector_backend = 'opencv', grayscale = False, enforce_detection = True, align = True):
...
async def find_target_size(model_name):
...
async def normalize_input(img, normalization = 'base'):
